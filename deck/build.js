...
/* ═════════════════════════ ۱ — عنوان و پاسخ اول */
{
  ...
  ['۱۷٬۶۳۶ رفرنس قابل ردیابی', '۱۱۰ آزمون خودکار، همه سبز', '۳۰ از ۳۰ عدد در آزمون دستی منطبق']
...
/* ═════════════════════════ ۱۰ — پایان */
{
  ...
  s.addText('پیوست یک کلیک فاصله دارد: نقشهٔ داده، تعریف متریک‌ها، منطق امتیازدهی، بک‌تست، آزمون دستی و محدودیت‌ها — در مستند فنی ۳۷ بخشی.',
